...
default phone.JJ  = phone.Character("JJ", "mod_assets/phone/default_icon.png", "JJ", 21, "#22Abf8")
default phone.mc      = phone.Character("MC", "mod_assets/phone/mc_icon.png", "mc", 35, "#714045")
default phone.ms  = phone.Character("M. Starke", "mod_assets/phone/default_icon.png", "ms", 21, "#22Abf8")
```
...
label start:          
    ...
    $ phone.message("mc", _("Sup 
    Sayo! Got a new phone"))
...
default phone.JJ    = phone.Character("JJ", "mod_assets/phone/default_icon.png", "JJ", 20, "#484848")
default phone.JJpark    = phone.Character("JJ", "mod_assets/phone/default_icon.png", "JJpark", 20, "#484848")
default phone.ms  = phone.Character("M. Starke", "mod_assets/phone/default_icon.png", "ms", 21, "#22Abf8")
default phone.mom  = phone.Character("Mom", "mod_assets/phone/default_icon.png", "mom", 21, "#22Abf8")
...
define phone_JJ  = Character(kind=JJ, screen="phone_say", who_style="phone_say_label", what_style="phone_say_dialogue")
define phone_mom  = Character(kind=mom, screen="phone_say", who_style="phone_say_label", what_style="phone_say_dialogue")
define phone_ms  = Character(kind=ms, screen="phone_say", who_style="phone_say_label", what_style="phone_say_dialogue")
...
default mc_JJ = phone.GroupChat("JJ", "mod_assets/phone/default_icon.png", "mc_JJ")
default mc_ms = phone.GroupChat("M. Starke", "mod_assets/phone/default_icon.png", "mc_ms")
default mc_JJ2 = phone.GroupChat("JJ", "mod_assets/phone/default_icon.png", "mc_JJ2")
default mc_mom = phone.GroupChat("Mom", "mod_assets/phone/default_icon.png", "mc_mom")
default mc_m = phone.GroupChat("Monker", "mod_assets/phone/default_icon.png", "mc_m")
...
init -1 python in phone:
    ...
    @register
    def __register_mc_JJ_messages():
        # using the object    v    we defaulted above
        register_group_chat(store.mc_JJ, "mc", "JJ")
        register_date("mc_JJ", 5, 2, 2022, 10, 11)
        register_message("mc_JJ", "JJ", _("Yo have you landed yet?"))

    @register
    def __register_mc_JJ_messages_2():
        # using the object    v    we defaulted above
        register_group_chat(store.mc_JJ, "mc", "JJ")
        register_date("mc_JJ", 5, 2, 2022, 10, 11)
        register_message("mc_JJ", "JJ", _("What's it like?"))
...
default mc_ms = phone.GroupChat("M. Starke", "mod_assets/phone/default_icon.png", "mc_ms"), "mc", "ms"
default mc_JJ2 = phone.GroupChat("JJ", "mod_assets/phone/default_icon.png", "mc_JJ2"), "mc", "JJ"
default mc_mom = phone.GroupChat("Mom", "mod_assets/phone/default_icon.png", "mc_mom"), "mc", "mom"
default mc_m = phone.GroupChat("Monker", "mod_assets/phone/default_icon.png", "mc_m"), "mc", "m"

#USE THIS CODE BELOW TO DEFINE A GROUP CHAT. THIS TOOK ME HOURS TO FIND OUT.

init python in phone:
    @register
    def __register_mc_ms_messages():
        # using the object    v    we defaulted above
        register_group_chat(store.mc_ms, "mc", "ms")
        register_date("mc_ms", 5, 2, 2022, 10, 25)
        register_message("mc_ms", "ms", _("We're meeting at the west food court! I brought a few of my friends over too! We're in our school uniforms so you should be able to see us."))

    @register
    def __register_mc_JJ2_messages():
        # using the object    v    we defaulted above
        register_group_chat(store.mc_JJ2, "mc", "JJ")
        register_date("mc_JJ2", 5, 3, 2022, 5, 45)
        register_message("mc_JJ2", "JJ", _("AYO BRO"))

    @register
    def __register_mc_JJ2_messages_2():
        # using the object    v    we defaulted above
        register_group_chat(store.mc_JJ2, "mc", "JJ")
        register_date("mc_JJ2", 5, 3, 2022, 5, 45)
        register_message("mc_JJ2", "JJ", _("NAH"))