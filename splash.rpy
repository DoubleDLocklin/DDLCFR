init python:
    menu_trans_time = 1
    splash_message_default = "This is a Doki Doki Literature Club Mod unaffilated with Team Salvato."
    splash_messages = [
    ...
    "Okaerinasai!",
    "1995.",
    "Created by David Locklin.",
    "Foreign relations are important.",
    "We need to understand eachother.",
    "Cross-Cultural Modding.",
    "Gaiko kankei.",
    "Everything is Oki-Doki!",
    "Scripting by w3ryfrate.",
    "The 1.0 demo released on April 6th, 2023.",
    "The 1.1 demo released on May 20, 2023.",
    "No, there's no free cupcakes.",
    "Need to talk to someone? Upgrade language!",
    "Not good at running? Upgrade fitness!",
    "Are you in the know? If not, upgrade intelligence!",
    "Rest in peace, Batebri.",
    "This 1.2 demo released on July 5th, 2023.",
    "Spritework by Chest_Boter."
...
image menu_bg:
    topleft
    "mod_assets/main_menu_background.png"


image game_menu_bg:
    topleft
    "mod_assets/gui/gray/menu_bg.png"
    menu_bg_loop
...
image menu_nav:
    "mod_assets/gui/gray/overlay/main_menu.png"
    menu_nav_move
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        with Dissolve(1.0)
        pause 1.0
        "Doki Doki Literature Club: Foreign Relations is a fan mod that is unaffilated with Team Salvato."
        "It is intended to be played after the original game has been completed, and contains spoilers for the original game."
        "Game files are needed for this game and can be downloaded for free at http://ddlc.moe/"
        menu:
            "Now, with that out of the way, are you ready to study abroad?"
            "Yes.":
                pass
    ...
    $ pause(1.0)
    show splash_warning "Team Relations presents..." with Dissolve(1.0, alpha=True)
    $ pause(1.5)
    hide splash_warning with Dissolve(0.5, alpha=True)
    $ pause(1.0)
    show menu_logo at truecenter with Dissolve(5, alpha=False)
    $ pause(3)
    hide menu_logo with dissolve
    $ pause(1.5)
